...
namespace MapEditor.UI
{
    ...
    public class MainView : Form, IMainView, IMessageFilter
    {
        ...
        /// </summary>
        public event Action OnViewTileset;

        /// <summary>
        /// Occurs when Layers button is clicked
        /// </summary>
        public event Action OnViewLayers;

        /// <summary>
        /// Occurs when Minimap button is clicked
        /// </summary>
        public event Action OnViewMinimap;
        ...
        public XnaRender SelectedXnaTab
        {
            get
            {
                if (closableTabControl1.TabPages.Count <= 0)
                    return null;
                return (XnaRender)closableTabControl1.SelectedTab.Controls[0];
            }
        }
        ...
        public string SelectedTabName
        {
            get
            {
                if (closableTabControl1.TabPages.Count <= 0)
                    return string.Empty;
                return closableTabControl1.SelectedTab.Name;
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.closableTabControl1.Size = new System.Drawing.Size(384, 312);
            this.closableTabControl1.SizeMode = System.Windows.Forms.TabSizeMode.Fixed;
            this.closableTabControl1.TabIndex = 3;
        ...
        public void AddTab(string name)
        {
            ...
            closableTabControl1.SelectedIndex = closableTabControl1.TabPages.Count - 1;
        }

        public void RemoveTab(string name)
        {
            for (int i = 0; i < closableTabControl1.TabPages.Count; i++)
            {
                if (closableTabControl1.TabPages[i].Name.Equals(name, StringComparison.OrdinalIgnoreCase))
                {
                    closableTabControl1.TabPages.RemoveAt(i);
                    break;
                }
            }
        }
